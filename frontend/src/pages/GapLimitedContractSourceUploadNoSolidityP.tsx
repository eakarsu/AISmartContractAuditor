...
export default function GapLimitedContractSourceUploadNoSolidityP() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-limited-contract-source-upload-no-solidity-p', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', fontFamily: 'system-ui, sans-serif' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 4 }}>Limited contract source upload (no Solidity parser route)</h1>
