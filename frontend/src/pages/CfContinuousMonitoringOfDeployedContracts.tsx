...
export default function CfContinuousMonitoringOfDeployedContracts() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/cf-continuous-monitoring-of-deployed-contracts', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', fontFamily: 'system-ui, sans-serif' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 4 }}>Continuous monitoring of deployed contracts</h1>
      <p style={{ color: '#666', marginBottom: 16 }}>AISmartContractAuditor - Custom feature</p>
