...
export default function GapNoContinuousMonitoringOfDeployedContrac() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-continuous-monitoring-of-deployed-contrac', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', fontFamily: 'system-ui, sans-serif' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 4 }}>No continuous monitoring of deployed contracts (on-chain listener)</h1>
      <p style={{ color: '#666', marginBottom: 16 }}>AISmartContractAuditor - Gap feature</p>
